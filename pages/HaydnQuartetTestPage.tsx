...
const questions: Question[] = [
  {
    id: 1,
    question: "What word best describes the opening of the melody?",
    options: ["Sequence", "Anacrusis", "Imitation", "Repetition"],
    correctAnswer: 1,
    explanation: "An anacrusis is a note or group of notes that precede the first strong beat of a bar, acting as an upbeat."
  },
  {
    id: 2,
    question: "Which two musical features are heard in bar 3?",
    options: ["Turn and Interval of a 3rd", "Trill and Perfect 4th", "Sequence and Major 2nd", "Imitation and Perfect 5th"],
    correctAnswer: 0,
    explanation: "A Turn is a type of melodic ornamentation that involves moving from the original note, up to the note above, back to the original note, down to the note below, and finally back to the original note. An Interval of a 3rd refers to the pitch distance between two notes, also often referred to as a skip."
  },
  {
    id: 3,
    question: "What term best describes the shape of the melody heard in bar 13?",
    options: ["Disjunct", "Conjunct", "Scalic", "Chromatic"],
    correctAnswer: 1,
    explanation: "Conjunct movement is smooth and stepwise, meaning the notes are close in pitch."
  },
  {
    id: 4,
    question: "What melodic device is heard in bar 12³ - bar 14³?",
    options: ["Imitation", "Sequence", "Repetition", "Inversion"],
    correctAnswer: 1,
    explanation: "A sequence involves repeating a melodic idea starting on a different pitch."
  },
  {
    id: 5,
    question: "In which bar number can the interval of an octave be heard in the melody?",
    options: ["Bar 14", "Bar 15", "Bar 16", "Bar 17"],
    correctAnswer: 2,
    explanation: "An octave is an interval representing the distance of eight steps between the lower and upper note."
  }
]

export default function HaydnQuartetTestPage() {
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-6 text-center">
              Haydn String Quartet - Test Results
            </h1>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-4 text-center">
              Haydn String Quartet - Melody Listening Test
            </h1>

...
const questions: Question[] = [
  {
    id: 1,
    question: "What is the correct term for the pattern heard at the beginning?",
    options: ["Sequence", "Motif", "Imitation", "Repetition"],
    correctAnswer: 1,
    explanation: "A motif (or Leitmotif) is a short segment or fragment of a melody, used as a distinctive building block."
  },
  {
    id: 2,
  ...
  {
    id: 3,
    question: "How is the melodic material contrasted in the second part of the extract (23\" – 52\")?",
  ...
  {
    id: 4,
    question: "What creates contrast in the second section?",
    options: ["Different instruments only", "Dynamic changes only", "Higher pitch and wider range", "Slower tempo only"],
    correctAnswer: 2,
    explanation: "The contrast is achieved through higher pitch, wider melodic range, more instruments playing, and louder dynamics."
  }
]

export default function MendelssohnOvertureTestPage() {
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-6 text-center">
              Mendelssohn Hebrides Overture - Test Results
            </h1>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-4 text-center">
              Mendelssohn Hebrides Overture - Melody Listening Test
            </h1>
          ...
          <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-6 mb-6 text-center">
            ...
            <div className="w-full h-12 bg-gray-200 dark:bg-gray-600 rounded flex items-center justify-center">
              <span className="text-gray-500">🎵 Mendelssohn Hebrides Overture Audio</span>
            </div>
          </div>

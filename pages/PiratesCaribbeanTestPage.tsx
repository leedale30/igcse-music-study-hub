...
const questions: Question[] = [
  {
    ...
    correctAnswer: 1,
    explanation: "A motif is a short segment or fragment of a melody, used as a distinctive building block. In film music, motifs often represent characters or themes."
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation: "Scalic means the melody moves along using the notes in sequential order of a scale, creating a sense of adventure and movement."
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation: "Higher in pitch and wider range creates dramatic contrast typical of film scores, building tension and excitement."
  },
  {
    id: 4,
    question: "What orchestral technique enhances the melody in this film score?",
    options: ["Solo piano", "String section unison", "Brass fanfare", "Woodwind choir"],
    correctAnswer: 2,
    explanation: "Brass fanfare is characteristic of adventure film scores like Pirates of the Caribbean, creating heroic and triumphant melodic statements."
  },
  {
    id: 5,
    question: "How does the melody support the film's narrative?",
    options: ["Creates romantic atmosphere", "Builds adventure and excitement", "Suggests mystery only", "Remains emotionally neutral"],
    correctAnswer: 1,
    explanation: "The melody builds adventure and excitement through rising phrases, bold intervals, and dynamic orchestration typical of action-adventure films."
  },
  {
    id: 6,
    question: "What rhythmic element drives the melodic energy?",
    options: ["Slow ballad tempo", "Syncopated patterns", "Simple 4/4 march", "Complex polyrhythms"],
    correctAnswer: 1,
    explanation: "Syncopated patterns create the driving energy and maritime feel characteristic of the Pirates of the Caribbean theme."
  }
]

export default function PiratesCaribbeanTestPage() {
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-6 text-center">
              Pirates of the Caribbean - Test Results
            </h1>
            ...
            <div className="space-y-6 mb-8">
              {questions.map((question, index) => (
                <div key={question.id} className="border-l-4 border-cyan-500 pl-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-4 text-center">
              Pirates of the Caribbean - Melody Listening Test
            </h1>
          ...
          <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-6 mb-6 text-center">
            ...
            <div className="w-full h-12 bg-gray-200 dark:bg-gray-600 rounded flex items-center justify-center">
              <span className="text-gray-500">🎵 Pirates of the Caribbean Audio</span>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            {currentQuestion === questions.length - 1 ? (
              ...
              <button
                ...
                className="bg-cyan-600 hover:bg-cyan-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-bold py-2 px-4 rounded transition-colors"
              >
                Next
              </button>
            )}

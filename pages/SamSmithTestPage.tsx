...
const questions: Question[] = [
  ...
  {
    id: 4,
    question: "What creates the melodic contrast in this popular music piece?",
    options: ["Different instruments only", "Dynamic changes only", "Higher pitch and wider range", "Slower tempo only"],
    correctAnswer: 2,
    explanation: "The contrast is achieved through higher pitch, wider melodic range, and different vocal techniques typical of contemporary popular music."
  },
  {
    id: 5,
    question: "What vocal technique is prominently featured in this Sam Smith track?",
    options: ["Vibrato", "Melisma", "Falsetto", "All of the above"],
    correctAnswer: 3,
    explanation: "Sam Smith's vocal style incorporates vibrato (slight variation in pitch), melisma (multiple notes on one syllable), and falsetto (high register singing)."
  }
]

export default function SamSmithTestPage() {
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-4 text-center">
              Sam Smith - Melody Listening Test
            </h1>
          ...
          <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-6 mb-6 text-center">
            ...
            <div className="w-full h-12 bg-gray-200 dark:bg-gray-600 rounded flex items-center justify-center">
              <span className="text-gray-500">🎵 Sam Smith Audio</span>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            {currentQuestion === questions.length - 1 ? (
              ...
              <button
                ...
                className="bg-purple-600 hover:bg-purple-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-bold py-2 px-4 rounded transition-colors"
              >
                Next
              </button>
            )}

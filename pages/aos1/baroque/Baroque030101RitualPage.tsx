...
const Baroque030101RitualPage: React.FC = () => {
  return (
    <article className="max-w-4xl mx-auto px-4 py-8">
      ...
      <nav className="mb-6 text-sm text-gray-500 dark:text-gray-400">
        ...
        <span className="mx-2">›</span>
        <span className="text-gray-700 dark:text-gray-300">Ritual - Baroque Music Cultural Function</span>
      </nav>

      {/* Page Header */}
      <header className="mb-10">
        <h1 className="text-4xl font-bold text-slate-800 dark:text-slate-100 mb-4">
          Ritual - Baroque Music Cultural Function
        </h1>
      ...
      ">
        <div dangerouslySetInnerHTML={{ __html: `<p>Music played a key role in sacred settings, where <strong>Oratorios</strong> (sacred settings of religious words, often from the Bible) and <strong>Masses</strong> were performed, typically in churches, using solo singers, chorus, and orchestra.</p>
<p>Other sacred vocal forms included <strong>Cantatas</strong> (vocal work in several movements with choir accompanied by orchestra), <strong>Chorales</strong>, <strong>Passions</strong>, and <strong>Anthems</strong>.</p>` }} />
      </div>
    </article>
  );
};

export default Baroque030101RitualPage;

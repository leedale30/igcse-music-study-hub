...
const Baroque030105SocialIdentityPage: React.FC = () => {
  return (
    <article className="max-w-4xl mx-auto px-4 py-8">
      ...
      <nav className="mb-6 text-sm text-gray-500 dark:text-gray-400">
        ...
        <span className="mx-2">›</span>
        <span className="text-gray-700 dark:text-gray-300">Social Identity - Baroque Music Cultural Function</span>
      </nav>

      {/* Page Header */}
      <header className="mb-10">
        <h1 className="text-4xl font-bold text-slate-800 dark:text-slate-100 mb-4">
          Social Identity - Baroque Music Cultural Function
        </h1>
      ...
      ">
        <div dangerouslySetInnerHTML={{ __html: `<p>NA - NOT APPLICABLE. While the concept of <em>nationalism</em> is related to social identity, it emerged later in the Romantic period, and is not a focus of Baroque study.</p>` }} />
      </div>
    </article>
  );
};

export default Baroque030105SocialIdentityPage;

...
const Baroque0304EconomicsAndPatronagePage: React.FC = () => {
  return (
...
<p>Composers and musicians were typically supported by systems of aristocratic or religious patronage.</p>
<ul>
<li> <strong>Performance Context:</strong> Music was performed mainly in the <strong>PRIVATE SALONS of the rich</strong> or in the <strong>CHURCH</strong>.</li>
<li> <strong>Ensemble Context:</strong> Performances in these smaller venues usually involved a <strong>SMALL ENSEMBLE</strong>—known as <strong>CHAMBER MUSIC</strong>.</li>
</ul>` }} />
      </div>
    </article>
  );
...
export default Baroque0304EconomicsAndPatronagePage;

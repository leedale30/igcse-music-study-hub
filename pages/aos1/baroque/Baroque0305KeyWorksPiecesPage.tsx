...
const Baroque0305KeyWorksPiecesPage: React.FC = () => {
  return (
...
<p>The syllabus dictates the mandatory study of specific <strong>Focus Works</strong> to illustrate the features of Baroque style, focusing on the concerto genre. <em>Note: These specific works will not be used in the final examination</em>.</p>
<ul>
<li> <strong>Solo Concerto Focus Work:</strong> Vivaldi: <em>Spring</em> from <em>The Four Seasons</em>, movement 1 (Allegro). This work is used to explore how musical features suggest extra-musical features (programme music).</li>
<li>  [YOUTUBE LINK: Vivaldi’s Spring, 1st Mvt. - Allegro (Suggested listening example)]</li>
<li> <strong>Concerto Grosso Focus Work:</strong> Handel: <em>Concerto Grosso in D major Op. 6, No. 5</em> (HWV 323), movements 1 (Larghetto e staccato), 2 (Allegro), 4 (Largo) and 6 (Menuet). This work is used to explore the specific contrasts between the <strong>ripieno</strong> (tutti) and <strong>concertino</strong> (soloists) sections.</li>
<li>  [YOUTUBE LINK: Handel’s Concerto Grosso Op. 6 No. 5, Mvt. 2 (Suggested listening example)]</li>
</ul>` }} />
      </div>
    </article>
  );
...
export default Baroque0305KeyWorksPiecesPage;

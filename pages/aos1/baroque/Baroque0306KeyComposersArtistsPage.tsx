...
const Baroque0306KeyComposersArtistsPage: React.FC = () => {
  return (
    <article className="max-w-4xl mx-auto px-4 py-8">
      ...
      ">
        <div dangerouslySetInnerHTML={{ __html: `<h3>3.6. Key Composers/Artists: Influential figures who shaped or revolutionized the music.</h3>
<ul>
<li> <strong>Antonio Vivaldi</strong> (1678–1741): Focus composer for the <strong>solo concerto</strong>.</li>
<li> <strong>George Frideric Handel</strong> (1685–1759): Focus composer for the <strong>concerto grosso</strong>.</li>
<li> <strong>Johann Sebastian Bach</strong> (1685–1750): Referenced as a composer who defined the end of the Baroque period.</li>
<li> <strong>Arcangelo Corelli:</strong> Cited in wider listening examples for his <em>Concerto Grosso in G minor, Op. 6 No. 8 ‘Christmas Concerto’</em>, influencing Handel.</li>
</ul>` }} />
      </div>
    </article>
  );
...
export default Baroque0306KeyComposersArtistsPage;

...
const Baroque0403NotationSystemPage: React.FC = () => {
  return (
    <article className="max-w-4xl mx-auto px-4 py-8">
      ...
      <nav className="mb-6 text-sm text-gray-500 dark:text-gray-400">
        ...
        <span className="mx-2">›</span>
        <span className="text-gray-700 dark:text-gray-300">Notation System - Baroque Music Language, Literacy, And Theory</span>
      </nav>

      {/* Page Header */}
      <header className="mb-10">
        <h1 className="text-4xl font-bold text-slate-800 dark:text-slate-100 mb-4">
          Notation System - Baroque Music Language, Literacy, And Theory
        </h1>
...
<p>In the Baroque period, Western music was primarily recorded using the precursor to modern staff notation.</p>
<h3>Staff Notation</h3>
<p>You are expected to read and understand the fundamentals of <strong>staff notation</strong>, including the treble, bass, and alto clefs. Score-reading is a core skill developed through Focus Works.</p>
<h3>Figured Bass</h3>
<p>A unique Baroque notation system called <strong>figured bass</strong> was developed as a shorthand for writing chords. This notation consists of a bass line written on the staff, accompanied by numbers (figures) placed below the notes. These figures indicate the chords that the continuo player (harpsichord, organ, or lute) should improvise, providing the harmonic basis for the piece.</p>
<p><a href="aos01-04-02-lyrics-text-analysis.html">← Previous: Lyrics &amp; Text Analysis</a></p>
<p><a href="../aos01-04-language-literacy-and-theory.html">← Back to Language, Literacy, and Theory</a></p>
<p><a href="aos01-04-04-oral-aural-tradition.html">Next: Oral/Aural Tradition →</a></p>` }} />
      </div>
    </article>
  );
};

export default Baroque0403NotationSystemPage;

...
const Baroque0501MusicTechnologyPage: React.FC = () => {
  return (
    <article className="max-w-4xl mx-auto px-4 py-8">
      ...
      ">
        <div dangerouslySetInnerHTML={{ __html: `<h3>Music Technology (Baroque)</h3>
<p>Technology in this period refers primarily to the mechanical engineering of instruments.</p>
<p>The <strong>Pipe Organ</strong> was the most complex machine of the era, capable of a massive range of sounds through complex wind systems and stops.</p>` }} />
      </div>
    </article>
  );
};

export default Baroque0501MusicTechnologyPage;

...
const Baroque0502RecordingAndProductionTechniquesPage: React.FC = () => {
  return (
    <article className="max-w-4xl mx-auto px-4 py-8">
      ...
      ">
        <div dangerouslySetInnerHTML={{ __html: `<h3>Recording and Production (Baroque)</h3>
<p><em>Note: Audio recording did not exist in the Baroque era.</em></p>
<p>However, "production" could be interpreted as the acoustic design of performance spaces (churches and courts) which heavily influenced the music written (e.g., long reverb times in cathedrals favoring slower harmonic changes).</p>` }} />
      </div>
    </article>
  );
};

export default Baroque0502RecordingAndProductionTechniquesPage;

...
const Baroque0503DistributionAndMediaPage: React.FC = () => {
  return (
    <article className="max-w-4xl mx-auto px-4 py-8">
      ...
      ">
        <div dangerouslySetInnerHTML={{ __html: `<h3>Distribution and Media (Baroque)</h3>
<p>Music was distributed primarily through:</p>
<ul>
<li><strong>Manuscripts:</strong> Hand-copied scores.</li>
<li><strong>Music Printing:</strong> Movable type for music became more common, allowing composers like Corelli to publish "Opus" collections.</li>
<li><strong>Patronage:</strong> Music was often exclusive to the court or church that commissioned it.</li>
</ul>` }} />
      </div>
    </article>
  );
...
export default Baroque0503DistributionAndMediaPage;

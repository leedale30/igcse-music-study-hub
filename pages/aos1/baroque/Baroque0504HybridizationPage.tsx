...
const Baroque0504HybridizationPage: React.FC = () => {
  return (
    <article className="max-w-4xl mx-auto px-4 py-8">
      ...
      ">
        <div dangerouslySetInnerHTML={{ __html: `<h3>Hybridization (Baroque)</h3>
<p>Hybridization occurred through the blending of national styles.</p>
<p><strong>The "Mixed Taste" (Goûts réunis):</strong> Composers like Couperin and Telemann deliberately blended the French style (dance-based, ornamented) with the Italian style (lyrical, virtuosic).</p>` }} />
      </div>
    </article>
  );
};

export default Baroque0504HybridizationPage;

...
const Classical0303MovementAndDancePage: React.FC = () => {
  return (
...
<p>Dance forms became integrated into the structural design of larger instrumental works, such as the <strong>Symphony</strong> and <strong>String Quartet</strong>.</p>
<ul>
<li> <strong>Minuet and Trio:</strong> The most notable dance form required for study is the <strong>Minuet and Trio</strong>, typically forming the third movement of a Classical work. The Minuet is invariably in <strong>triple metre</strong>.</li>
<li> <strong>Wider Examples:</strong> You will study examples like the <strong>Minuet and Trio</strong> from Mozart’s <em>String Quartet No. 17 in B flat, K. 458 ‘The Hunt’</em> and Mozart’s <em>9 Variations on a Minuet by Duport, K.573</em>.</li>
<li>  [AUDIO: Extract of Mozart’s <em>Minuet</em> from K. 458 to demonstrate triple metre and clear structure]</li>
</ul>` }} />
      </div>
    </article>
  );
...
export default Classical0303MovementAndDancePage;

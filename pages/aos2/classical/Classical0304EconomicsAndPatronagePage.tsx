...
const Classical0304EconomicsAndPatronagePage: React.FC = () => {
  return (
...
<p>The system of patronage was paramount for supporting music creation.</p>
<ul>
<li> <strong>Patronage System:</strong> Composers like Haydn and Mozart were frequently reliant on the <strong>patronage of wealthy individuals</strong> and the courts of nobility. This meant composers were essentially employed to produce music specifically for the aristocrat's household or court functions.</li>
</ul>` }} />
      </div>
    </article>
  );
...
export default Classical0304EconomicsAndPatronagePage;

...
const Classical0306KeyComposersArtistsPage: React.FC = () => {
  return (
...
<p>The following composers are central to the study of the Classical period:</p>
<ul>
<li> <strong>Wolfgang Amadeus Mozart</strong> (1756–1791): Focus composer whose work is used to demonstrate the stylistic features of the era.</li>
<li> <strong>Joseph Haydn</strong> (1732–1809): Featured in wider listening examples for his chamber music and symphonies.</li>
<li> <strong>Ludwig van Beethoven</strong> (1770–1827): Featured in wider listening examples for his early Classical works.</li>
</ul>` }} />
      </div>
    </article>
  );
...
export default Classical0306KeyComposersArtistsPage;

...
const Classical0501MusicTechnologyPage: React.FC = () => {
  return (
    <article className="max-w-4xl mx-auto px-4 py-8">
      ...
      ">
        <div dangerouslySetInnerHTML={{ __html: `<h3>Music Technology (Classical)</h3>
<p><strong>The Fortepiano:</strong> Invented by Cristofori, it replaced the harpsichord. Its hammer mechanism allowed for dynamic variation (loud and soft) based on touch, revolutionizing musical expression.</p>
<p><strong>Clarinet:</strong> The clarinet was developed and became a standard member of the orchestra during this time.</p>` }} />
      </div>
    </article>
  );
};

export default Classical0501MusicTechnologyPage;

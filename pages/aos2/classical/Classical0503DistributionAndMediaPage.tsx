...
const Classical0503DistributionAndMediaPage: React.FC = () => {
  return (
    <article className="max-w-4xl mx-auto px-4 py-8">
      ...
      ">
        <div dangerouslySetInnerHTML={{ __html: `<h3>Distribution and Media (Classical)</h3>
<p>The rise of the <strong>Middle Class</strong> changed distribution:</p>
<ul>
<li><strong>Public Concerts:</strong> Music moved from private courts to public halls.</li>
<li><strong>Publishing:</strong> A booming market for sheet music for amateur home performance (especially piano sonatas and songs).</li>
</ul>` }} />
      </div>
    </article>
  );
...
export default Classical0503DistributionAndMediaPage;

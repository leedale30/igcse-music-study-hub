...
const Classical0504HybridizationPage: React.FC = () => {
  return (
    <article className="max-w-4xl mx-auto px-4 py-8">
      ...
      ">
        <div dangerouslySetInnerHTML={{ __html: `<h3>Hybridization (Classical)</h3>
<p>Composers like Mozart travelled extensively, absorbing and blending styles.</p>
<p>Example: Mozart's operas often blend <em>Opera Seria</em> (serious, heroic) with <em>Opera Buffa</em> (comic, everyday characters), creating a hybrid dramatic form.</p>` }} />
      </div>
    </article>
  );
};

export default Classical0504HybridizationPage;

...
const Classical05TechnologyAndInnovationPage: React.FC = () => {
  return (
    <article className="max-w-4xl mx-auto px-4 py-8">
      ...
      ">
        <div dangerouslySetInnerHTML={{ __html: `<h3>Technology and Innovation in the Classical Era</h3>
<p>The most significant technological innovation of this period was the invention and rise of the <strong>Piano</strong>.</p>` }} />
      </div>
    </article>
  );
};

export default Classical05TechnologyAndInnovationPage;

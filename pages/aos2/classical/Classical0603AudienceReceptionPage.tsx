...
const Classical0603AudienceReceptionPage: React.FC = () => {
  return (
...
<p>The IGCSE syllabus mandates an active, analytical listening approach to Western classical repertoire.</p>
<ul>
<li> <strong>Context of Reception:</strong> Classical music was commissioned and consumed primarily in the <strong>courts and private salons</strong> of wealthy patrons (patronage). The emergence of public concerts also broadened access.</li>
<li> <strong>Listening Skill Requirement:</strong> For the candidate, engagement means cultivating <strong>aural awareness, perception, and discrimination</strong>. Learners are expected to demonstrate an understanding of musical features and concepts using <strong>appropriate musical terminology</strong>.</li>
<li> <strong>Interpretation through Analysis:</strong> Interpretation is formalized through analytical skills, especially the ability to use <strong>score reading</strong>. Candidates must apply their knowledge of focus works (like the Mozart Quintet) to identify features in related extracts during the examination, specifically relating to <strong>structure, genre, or style</strong>. They may be asked to identify form using terms like AABA.</li>
</ul>` }} />
      </div>
    </article>
  );
...
export default Classical0603AudienceReceptionPage;

...
<ul>
<li> <strong>EXCLUSION:</strong> Candidates are explicitly <strong>not expected to identify or name any specific composers</strong> for extracts from Area of Study 7 in the examination. You must focus only on the musical features.</li>
</ul>
<p>NOT APPLICABLE.</p>` }} />
      </div>
    </article>

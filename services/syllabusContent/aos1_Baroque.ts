  ...
  children: [
    {
      ...
      title_zh: '核心音乐元素',
      path: '/aos/baroque/core-musical-elements',
      content: 'Dynamics, rhythm, metre, tempo, melody, harmony, tonality, texture, timbre, and structure.',
      children: [
        { id: 'aos1-dynamics', title: 'Dynamics', path: '/aos/baroque/core-musical-elements/dynamics', content: 'Dynamic markings and terraced dynamics in Baroque music.' },
        { id: 'aos1-rhythm', title: 'Rhythm', path: '/aos/baroque/core-musical-elements/rhythm', content: 'Rhythmic patterns and motor rhythm.' },
        { id: 'aos1-metre', title: 'Metre', path: '/aos/baroque/core-musical-elements/metre', content: 'Time signatures and metric organization.' },
        { id: 'aos1-tempo', title: 'Tempo', path: '/aos/baroque/core-musical-elements/tempo', content: 'Italian tempo markings and Baroque conventions.' },
        { id: 'aos1-melody', title: 'Melody', path: '/aos/baroque/core-musical-elements/melody', content: 'Melodic characteristics and sequences.' },
        { id: 'aos1-harmony', title: 'Harmony', path: '/aos/baroque/core-musical-elements/harmony', content: 'Functional harmony and diatonic relationships.' },
        { id: 'aos1-tonality', title: 'Tonality', path: '/aos/baroque/core-musical-elements/tonality', content: 'Major/minor keys and modulation.' },
        { id: 'aos1-texture', title: 'Texture', path: '/aos/baroque/core-musical-elements/texture', content: 'Polyphonic, homophonic, and imitative textures.' },
        { id: 'aos1-timbre', title: 'Timbre', path: '/aos/baroque/core-musical-elements/timbre', content: 'Instrumental timbres and basso continuo.' },
        { id: 'aos1-structure', title: 'Structure/Form', path: '/aos/baroque/core-musical-elements/structure-form', content: 'Binary, ternary, ritornello, and fugal forms.' },
      ]
    },
    {
      ...
      title_zh: '声源与技巧',
      path: '/aos/baroque/sound-sources-and-techniques',
      content: 'Instrumentation, organology, vocal techniques, and composition methods.',
      children: [
        { id: 'aos1-instrumentation', title: 'Instrumentation', path: '/aos/baroque/sound-sources-and-techniques/instrumentation', content: 'Baroque orchestra and ensembles.' },
        { id: 'aos1-organology', title: 'Organology', path: '/aos/baroque/sound-sources-and-techniques/organology', content: 'Period instruments and their construction.' },
        { id: 'aos1-vocal-techniques', title: 'Vocal Techniques', path: '/aos/baroque/sound-sources-and-techniques/vocal-techniques', content: 'Baroque vocal styles and ornamentation.' },
        { id: 'aos1-extended-techniques', title: 'Extended Techniques', path: '/aos/baroque/sound-sources-and-techniques/extended-techniques', content: 'Tremolo, pizzicato, and other techniques.' },
        { id: 'aos1-improvisation', title: 'Improvisation', path: '/aos/baroque/sound-sources-and-techniques/improvisation', content: 'Figured bass realization and ornamentation.' },
        { id: 'aos1-composition', title: 'Composition Techniques', path: '/aos/baroque/sound-sources-and-techniques/composition-techniques', content: 'Counterpoint, fugue, and canon.' },
      ]
    },
    {
      ...
      title_zh: '文化与历史背景',
      path: '/aos/baroque/cultural-and-historical-context',
      content: 'Historical background, key composers, patronage, and performance practice.',
      children: [
        { id: 'aos1-cultural-function', title: 'Cultural Function', path: '/aos/baroque/cultural-and-historical-context/cultural-function', content: 'Role of music in society.' },
        { id: 'aos1-historical', title: 'Historical Background', path: '/aos/baroque/cultural-and-historical-context/historical-background', content: 'The Baroque era 1600-1750.' },
        { id: 'aos1-dance', title: 'Movement & Dance', path: '/aos/baroque/cultural-and-historical-context/movement-and-dance', content: 'Dance forms and suites.' },
        { id: 'aos1-patronage', title: 'Economics & Patronage', path: '/aos/baroque/cultural-and-historical-context/economics-and-patronage', content: 'Court and church patronage.' },
        { id: 'aos1-key-works', title: 'Key Works & Pieces', path: '/aos/baroque/cultural-and-historical-context/key-works-pieces', content: 'Important compositions to study.' },
        { id: 'aos1-composers', title: 'Key Composers', path: '/aos/baroque/cultural-and-historical-context/key-composers-artists', content: 'Bach, Handel, Vivaldi, and others.' },
        { id: 'aos1-performance', title: 'Performance Practice', path: '/aos/baroque/cultural-and-historical-context/performance-practice', content: 'Historical performance and interpretation.' },
      ]
    },
    {
      ...
      title_zh: '语言、读写与理论',
      path: '/aos/baroque/language-literacy-and-theory',
      content: 'Terminology, notation systems, and analytical concepts.',
      children: [
        { id: 'aos1-terminology', title: 'Specific Terminology', path: '/aos/baroque/language-literacy-and-theory/specific-terminology', content: 'Baroque musical vocabulary.' },
        { id: 'aos1-lyrics', title: 'Lyrics & Text Analysis', path: '/aos/baroque/language-literacy-and-theory/lyrics-and-text-analysis', content: 'Word painting and text setting.' },
        { id: 'aos1-notation', title: 'Notation System', path: '/aos/baroque/language-literacy-and-theory/notation-system', content: 'Figured bass and score notation.' },
        { id: 'aos1-oral-aural', title: 'Oral/Aural Tradition', path: '/aos/baroque/language-literacy-and-theory/oral-aural-tradition', content: 'Listening and aural traditions.' },
      ]
    },
    {
      id: 'aos1-technology',
      ...
      title_zh: '技术与创新',
      path: '/aos/baroque/technology-and-innovation',
      content: 'Music technology, recording, and distribution in the Baroque context.',
      children: [
        { id: 'aos1-music-tech', title: 'Music Technology', path: '/aos/baroque/technology-and-innovation/music-technology', content: 'Instrument making and development.' },
        { id: 'aos1-recording', title: 'Recording & Production', path: '/aos/baroque/technology-and-innovation/recording-and-production-techniques', content: 'Modern recordings of Baroque music.' },
        { id: 'aos1-distribution', title: 'Distribution & Media', path: '/aos/baroque/technology-and-innovation/distribution-and-media', content: 'Music printing and dissemination.' },
        { id: 'aos1-hybridization', title: 'Hybridization', path: '/aos/baroque/technology-and-innovation/hybridization', content: 'Cross-genre influences.' },
      ]
    },
    {
      id: 'aos1-analytical',
      ...
      title_zh: '分析领域',
      path: '/aos/baroque/analytical-domains',
      content: 'Genre, style, aesthetics, audience reception, and geographic influence.',
      children: [
        { id: 'aos1-genre-style', title: 'Genre & Style', path: '/aos/baroque/analytical-domains/genre-and-style', content: 'Musical genres of the Baroque.' },
        { id: 'aos1-aesthetic', title: 'Aesthetic Values', path: '/aos/baroque/analytical-domains/aesthetic-values', content: 'Doctrine of affections and beauty.' },
        { id: 'aos1-audience', title: 'Audience Reception', path: '/aos/baroque/analytical-domains/audience-reception', content: 'Historical and modern reception.' },
        { id: 'aos1-political', title: 'Political/Social Commentary', path: '/aos/baroque/analytical-domains/political-social-commentary', content: 'Music and power.' },
        { id: 'aos1-geographic', title: 'Geographic Influence', path: '/aos/baroque/analytical-domains/geographic-influence', content: 'Italian, French, German, English styles.' },
      ]
    },
    {
      id: 'aos1-glossary',

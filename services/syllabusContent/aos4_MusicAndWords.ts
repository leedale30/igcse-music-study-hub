  ...
  children: [
    {
      ...
      path: '/areas-of-study/music-and-words/art-song',
...
`
    },
    {
      ...
      title_zh: '重点领域：合唱音乐',
      path: '/areas-of-study/music-and-words/choirs',
...
`
    },
    {
      ...
      path: '/areas-of-study/music-and-words/popular-song-and-musicals',
      ...
      children: [
        {
          ...
          path: '/areas-of-study/music-and-words/popular-song-and-musicals/popular-song',
...
*   **表演与发行：** 歌曲在**现场音乐会**上表演，并通过**广播媒体**如音乐电视（如MTV）和数字流媒体（如YouTube、Spotify）发行。`,
          children: [
            ...popSongAoS.children,
            {
              ...
              title: 'Songwriting',
              title_zh: '歌曲创作',
              path: '/areas-of-study/music-and-words/popular-song-and-musicals/popular-song/songwriting',
...
*   **技术和工具：** 现代歌曲创作通常涉及**数字音频工作站(DAW)**、**虚拟乐器**、**循环库**和**协作软件**，这些使远程共同创作和音乐想法的快速原型制作成为可能。`
        ...
        },
        {
          ...
          path: '/areas-of-study/music-and-words/popular-song-and-musicals/songs-from-musicals',
...
*   **制作与表演背景：** 这包括**现场表演焦点**，其中声音清晰度是关键；在伦敦西区和百老汇等**剧院**表演；少量使用**效果**如混响；以及通过录音和电影版本**发行**。`
    ...
    },
    {
      ...
      title_zh: '音乐与文字的主要特征',
      path: '/areas-of-study/music-and-words/key-features',
...
`
    },
    {
      ...
      title_zh: '重点作品与范例',
      path: '/areas-of-study/music-and-words/starting-points',
